...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#111827] text-white pt-6 md:pt-12 pb-3 border-t border-white/5" aria-label="Site Sonu">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-y-6 gap-x-4 mb-6 md:mb-10">
          ...
          <div className="col-span-2 lg:col-span-1 space-y-1.5">
            ...
            {/* Kontrast için text-gray-400 -> text-gray-300 yapıldı */}
            <p className="text-gray-300 text-[8px] md:text-[10px] leading-tight font-medium italic opacity-80">
          ...
          <div className="col-span-1 text-right lg:text-left">
            ...
            <ul className="space-y-2">
              <li className="flex items-center justify-end lg:justify-start space-x-1.5">
                {/* Kontrast için metin rengi iyileştirildi */}
              ...
              <li className="flex items-center justify-end lg:justify-start space-x-1.5">
                <a 
                  ...
                  aria-label={`Telefon numaramız: ${settings?.contactInfo?.phone || "0501 085 20 35"}`}
                >
        ...
        {/* SOSYAL MEDYA - Aria Labels Eklendi (Skor 100 için) */}
        <div className="flex flex-col items-center py-4 border-t border-white/5 space-y-2.5">
          <h4 className="text-white font-black text-[7px] md:text-[9px] uppercase tracking-[0.3em] opacity-60">Takip Edin</h4>
          <div className="flex space-x-3">
            <a 
              ...
              aria-label="Alfa Eğitim Kurumları Instagram Hesabı"
            >
            ...
            <a 
              ...
              rel="noopener noreferrer" 
              className="w-6 h-6 bg-white/5 rounded-md flex items-center justify-center hover:bg-[#8B1A1A] transition-all outline-none focus:ring-1 focus:ring-white"
              aria-label="Alfa Eğitim Kurumları Facebook Hesabı"
            >
        ...
        {/* ALT KISIM */}
        <div className="pt-2.5 border-t border-white/5 flex flex-row justify-between items-center opacity-60">
          <p className="text-gray-300 text-[6px] md:text-[8px] font-black uppercase tracking-widest italic">
            © 2026 {settings?.title?.toUpperCase() || "ALFA EĞİTİM KURUMLARI"}. Tüm hakları saklıdır.
          </p>
          <div className="flex items-center space-x-1 text-gray-300 text-[6px] font-bold">
            <span>BY</span>
