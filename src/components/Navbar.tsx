  ...
  return (
    <nav className="bg-white border-b border-gray-100 sticky top-0 z-50 shadow-sm">
      ...
      <div className={`fixed inset-0 z-[60] md:hidden transition-all duration-500 ${isOpen ? "visible" : "invisible pointer-events-none"}`}>
        ...
        <div className={`absolute top-0 right-0 w-[80%] h-full bg-white shadow-2xl transition-transform duration-500 ease-[cubic-bezier(0.32,0,0.67,0)] ${isOpen ? "translate-x-0" : "translate-x-full"}`}>
