        ...
        <div className="bg-alfa-koyu rounded-[2.5rem] md:rounded-[4rem] overflow-hidden shadow-2xl flex flex-col lg:flex-row items-stretch border border-white/10">
          ...
          <div className="flex-1 p-8 md:p-20 flex flex-col justify-center relative">
            ...
            <div className="relative z-10">
              ...
              {/* Bilgiler: Mobilde Yan Yana Grid Yapısı */}
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-10 mb-10">
                <div className="flex items-start gap-4 group">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300 font-bold text-sm md:text-xl leading-tight">
                      Tepeköy, 4505 Sk. No:9 Torbalı / İzmir
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 group">
                  ...
                  <div>
                    ...
                    <p className="text-white font-[1000] text-lg md:text-3xl tracking-tighter hover:text-alfa-bordo transition-colors">
                      0501 085 20 35
                    </p>
                  </div>
                </div>
          ...
          {/* Sağ Taraf: Harita - Mobilde Yüksekliği Sınırlandı */}
