    ...
    <section className="relative pt-12 pb-24 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col lg:flex-row items-center gap-16 md:gap-24">
          ...
          {/* Sol Metin - Kontrast Tavan Yapıldı */}
          <div className="flex-1 text-center lg:text-left">
            
            {/* Rozet - Arka planı koyulaştırdık ki içindeki yazı okunsun */}
            ...
            {/* Ana Başlık - Tam Siyah ve Dev Puntolar */}
            <h1 className="text-6xl lg:text-[82px] font-[1000] text-black leading-[0.95] tracking-[-0.04em] mb-10">
              GELECEĞİ <br />
              <span className="text-[#8B1A1A]">ALFA EĞİTİM KURUMLARI</span> <br />
              İLE İNŞA EDİN
            </h1>
            
            {/* Açıklama Metni - Rengi tam siyah yaptık (#000000) ve kalınlaştırdık */}
            <p className="text-xl md:text-2xl text-black font-bold leading-relaxed max-w-xl mb-12 opacity-90">
          ...
          {/* Sağ Afiş - Kalın Çerçeve ile Belirginleştirildi */}
